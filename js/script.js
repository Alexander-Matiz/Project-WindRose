...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let dishesSlider = new Swiper('.menu-dishes__slider', {
    slidesPerView: 1,
    spaceBetween: 30,
    loop: false,
    slideClass: 'menu-dishes__slider-slide',
    wrapperClass: 'menu-dishes__slider-wrapper',
    watchOverflow: true,
    observer: true,
    observeParents: true,
    pagination: {
      el: '.menu-dishes__slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.menu-dishes__btn-next',
      prevEl: '.menu-dishes__btn-prev',
    },
    scrollbar: {
      el: '.swiper-scrollbar',
      draggable: true,
  ...
  const sharesSliderBlock = document.querySelector('.shares-block__slider');

  let sharesSliderItem = new Swiper(sharesSliderBlock, {
    slidesPerView: 1,
    spaceBetween: 30,
    loop: false,
    slideClass: 'shares-block__slider-slide',
    wrapperClass: 'shares-block__slider-wrapper',
    watchOverflow: true,
    grabCursor: true,
    observer: true,
    observeParents: true,
    pagination: {
      el: '.shares-block__slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.shares-block__btn-next',
      prevEl: '.shares-block__btn-prev',
    },
  })



  let aboutSliderBlock = document.querySelector('.about__slider');
  let aboutMobileSliderBlock = document.querySelector('.about-mobile__slider');

  let aboutSlider = null;
  let aboutMobileSlider = null;

  let mediaQuerySize = 992; 

  function aboutSliderInit() {
    if (!aboutSlider) {
      aboutSlider = new Swiper(aboutSliderBlock, {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: false,
  ...
  function aboutMobileSliderInit() {
    if (!aboutMobileSlider) {
      aboutMobileSlider = new Swiper(aboutMobileSliderBlock, {
        slidesPerView: 1,
        spaceBetween: 40,
        loop: false,
        autoHeight: true,
        slideClass: 'about-mobile__slider-slide',
        wrapperClass: 'about-mobile__slider-wrapper',
        watchOverflow: true,
        grabCursor: true,
        observer: true,
        observeParents: true,
        pagination: {
          el: '.about-mobile__slider-pagination',
          clickable: true,
        },
        navigation: {
          nextEl: '.about-mobile__btn-next',
          prevEl: '.about-mobile__btn-prev',
        }
      })
    }
  }

  function aboutMobileSliderDestroy() {
    if (aboutMobileSlider) {
      aboutMobileSlider.destroy();
      aboutMobileSlider = null;
    }
  }
  ...
  window.addEventListener('load', function () {
    ...
    let innerWindth = windowWidth - scrollbarWidth();

    if (innerWindth >= mediaQuerySize) {
      aboutMobileSliderDestroy()
      aboutSliderInit()
    } else {
      aboutSliderDestroy()
      aboutMobileSliderInit()
    }
  });



  const banquetsSliderBlock = document.querySelector('.banquets__slider');

  let banquetsSliderItem = new Swiper(banquetsSliderBlock, {
    slidesPerView: 'auto',
    spaceBetween: 30,
    loop: false,
    slideClass: 'banquets__slider-slide',
    wrapperClass: 'banquets__slider-wrapper',
    watchOverflow: true,
    centeredSlides: true,
    grabCursor: true,
    ...
    pagination: {
      el: '.banquets__slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.banquets__btn-next',
      prevEl: '.banquets__btn-prev',
    },
    breakpoints: {
      320: {
        slidesPerView: 1,
  ...
  let dishesCategoryText = document.querySelector('.dishes-category-mobile__category-text');

  let submenuNav = document.querySelectorAll('.dishes-category__sub-menu.submenu-item'),
    submenuContent = document.querySelectorAll('.submenu-item-content'),
    submenuName;

  let selectSubmenu = function () {
    ...
    function selectNav() {
      ...
      submenuName = this.getAttribute('data-submenu');
      selectContent(submenuName);
    }

    function selectContent(submenuName) {
  ...
  let tabNavMenu = document.querySelectorAll('.tab-nav__item.dishes-category-mobile__tab, .tab-nav__item.dishes-category__tab'),
      tabNavContacts = document.querySelectorAll('.tab-nav__item.contacts__tab'),
      tabNavOrdering = document.querySelectorAll('.tab-nav__item.ordering-tab__btn'),
      tabContentMenu = document.querySelectorAll('.tab.menu-dishes__content'),
      tabContentContacts = document.querySelectorAll('.tab.contacts__content'),
      tabContentOrdering = document.querySelectorAll('.tab.ordering-tab__content'),
      tabName;

  let selectTab = function () {
    tabNavMenu.forEach(item => {
      item.addEventListener('click', selectNavMenu);
    });

    tabNavContacts.forEach(item => {
      item.addEventListener('click', selectNavContact);
    })

    tabNavOrdering.forEach(item => {
      item.addEventListener('click', selectNavOrdering);
    })
    ...
    function selectNavMenu() {
      ...
      selectContent(tabName, tabContentMenu);
    }
    ...
    function selectNavContact() {
      ...
      this.classList.add('is-active');
      tabName = this.getAttribute('data-tab-name');
      selectContent(tabName, tabContentContacts);
    }

    function selectNavOrdering() {
      tabNavOrdering.forEach(item => {
        item.classList.remove('is-active');
      });
      this.classList.add('is-active');
      tabName = this.getAttribute('data-tab-name');
      selectContent(tabName, tabContentOrdering);
    }

    function selectContent(tabName, tabContent) {
  ...
  let closeCategoryMenu = function () {
    tabNavMenu.forEach(item => {
      item.addEventListener('click', function () {
        dishesCategoryText.textContent = this.textContent;
      });
    });
  };
  ...
  tabNavMenu.forEach(item => {
    item.addEventListener('click', function () {
      submenuNav.forEach(itemNav => {
        itemNav.classList.remove('is-active');
      });
      submenuContent.forEach(itemContent => {
        itemContent.classList.remove('is-active');
      });
    });
  });
  ...
  let btnClose = document.querySelectorAll('.dish-card__modal-close');

  btnClose.forEach(item => {
    item.addEventListener('click', function () {
      dishCard.forEach(itemCard => {
  ...
  let headerMobileInner = document.querySelector('.header-mobile__inner'),
    headerMobileNavModal = document.querySelector('.header-mobile__navigation-modal'),
    headerMobileItem = document.querySelectorAll('.header-mobile__menu-item');

  let headerMobileBtnOpen = document.querySelectorAll('.header-mobile__menu-btn'),
    headerMobileBtnClose = document.querySelectorAll('.header-mobile__modal-close');

  headerMobileBtnOpen.forEach(item => {
    item.addEventListener('click', function () {
      headerMobileInner.classList.add('header-mobile__inner--animation');
      headerMobileNavModal.classList.add('header-mobile__navigation-modal--active');
      bodyFixPosition();
    });
  });

  headerMobileBtnClose.forEach(item => {
    item.addEventListener('click', function () {
      headerMobileInner.classList.remove('header-mobile__inner--animation');
      headerMobileNavModal.classList.remove('header-mobile__navigation-modal--active');
      bodyUnfixPosition();
    });
  });
  ...
  let dishesCategoryMobile = document.querySelector('.dishes-category-mobile'),
    dishesCategoryMobileTab = document.querySelectorAll('.dishes-category-mobile__tab'),
    dishesCategoryMobileWrapper = document.querySelector('.dishes-category-mobile__category-wrapper');

  let dishesCategoryMobileBtn = document.querySelectorAll('.dishes-category-mobile__menu-btn'),
    dishesCategoryBtnClose = document.querySelectorAll('.dishes-category-mobile .dishes-category-mobile__modal-close');

  dishesCategoryMobileTab.forEach(item => {
    item.addEventListener('click', function () {
      setTimeout(() => {
        dishesCategoryMobile.classList.remove('dishes-category-mobile--active');
        bodyUnfixPosition();
      }, 500);
    });
  });

  dishesCategoryMobileBtn.forEach(item => {
    item.addEventListener('click', function () {
      dishesCategoryMobile.classList.add('dishes-category-mobile--active');
      bodyFixPosition();
    });
  });

  dishesCategoryBtnClose.forEach(item => {
    item.addEventListener('click', function () {
      dishesCategoryMobile.classList.remove('dishes-category-mobile--active');
      bodyUnfixPosition();
    });
  ...
  let dishCard = document.querySelectorAll('.menu-dishes-mobile__slider-item');
  let dishCardModalBtnClose = document.querySelectorAll('.dish-card__modal-close');

  dishCard.forEach(item => {
  ...
  dishCardModalBtnClose.forEach(item => {
    item.addEventListener('click', function () {
      dishCard.forEach(item => {
        item.classList.remove('is-active');
      });
  ...
  let formContactUs = document.querySelectorAll('.form-contact-us'),
    formFeedback = document.querySelector('.form-feedback'),
    formSuccess = document.querySelectorAll('.form-success'),
    form = document.querySelectorAll('.form');

  let formCloseBtn = document.querySelectorAll('.form-feedback__close'),
    formModalBtn = document.querySelectorAll('.form-modal'),
    banquetsBtn = document.querySelectorAll('.banquets__btn'),
    headerBookingBtn = document.querySelectorAll('.header__booking-link'),
    footerBookingBtn = document.querySelectorAll('.footer__booking-link'),
    formSuccessBtn = document.querySelectorAll('.form-success__btn');

  formModalBtn.forEach(item => {
    item.addEventListener('click', function () {
      let formFeedback = document.querySelector('.form-feedback');
      formFeedback.classList.add('form-feedback--active');
      bodyFixPosition();
    });
  });

  formCloseBtn.forEach(item => {
    item.addEventListener('click', function () {
      form.forEach(formItem => {
        formItem.classList.remove('form-feedback--active', 'form-contact-us--active');
        bodyUnfixPosition();
      });
    });
  });

  banquetsBtn.forEach(item => {
    item.addEventListener('click', function () {
      formContactUs.forEach(itemForm => {
        itemForm.classList.add('form-contact-us--active');
        bodyFixPosition();
      });
    });
  });

  headerBookingBtn.forEach(item => {
    item.addEventListener('click', function () {
      formContactUs.forEach(itemForm => {
        itemForm.classList.add('form-contact-us--active');
        bodyFixPosition();
  ...
  formSuccessBtn.forEach(item => {
    item.addEventListener('click', function () {
      form.forEach(itemForm => {
        itemForm.classList.remove('form-feedback--active', 'form-contact-us--active');
        bodyUnfixPosition();
      });
      formSuccess.forEach(itemForm => {
        itemForm.classList.remove('form-success--active');
        bodyUnfixPosition();
      });
    });
  });
  ...
  document.addEventListener('keydown', function (event) {
    if (event.keyCode == 27) {
      form.forEach(item => {
        item.classList.remove('form-feedback--active', 'form-contact-us--active', 'form-success--active');
      });
      setTimeout(() => {
        headerMobileNavModal.classList.remove('header-mobile__navigation-modal--active');
        dishesCategoryMobile.classList.remove('dishes-category-mobile--active');
  ...
  let linkNav = document.querySelectorAll('.scroll-to'),
    V = 0.45;
